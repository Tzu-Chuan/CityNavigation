...
public class Member_DB
{
    ...
    public DataSet getMemberList(string pStart, string pEnd, string sortStr)
    {
        ...
        sb.Append(@"
select Member.*,City.C_Item_cn as CityName,Comp.C_Item_cn as Competence
into #tmpAll from Member 
left join CodeTable as City on City.C_Group='02' and City.C_Item=M_City
...
";
    ...
    public DataTable getMemberById()
    {
        ...
        sb.Append(@"select Member.*,City.C_Item_cn as CityName,Comp.C_Item_cn as Competence from Member 
left join CodeTable as City on City.C_Group='02' and City.C_Item=M_City
left join CodeTable as Comp on Comp.C_Group='03' and Comp.C_Item=M_Competence

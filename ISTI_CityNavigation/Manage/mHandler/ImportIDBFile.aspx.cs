    ...
    public partial class ImportIDBFile : System.Web.UI.Page
    {
        ...
        private void DoCitySummaryTable(IWorkbook workbook, SqlConnection oConn, SqlTransaction myTrans)
        {
            ...
            for (int i = 2; i < sheet.PhysicalNumberOfRows-1; i++)
            {
                ...
                row["CS_AllArea"] = sheet.GetRow(i).GetCell(10).ToString().Trim();
                row["CS_CityArea"] = sheet.GetRow(i).GetCell(11).ToString().Trim();
                row["CS_CityAreaDetail"] = sheet.GetRow(i).GetCell(12).ToString().Trim();
                row["CS_PlanTotalMoney"] = sheet.GetRow(i).GetCell(13).ToString().Trim();
                row["CS_PlanSubMoney"] = sheet.GetRow(i).GetCell(14).ToString().Trim();
                row["CS_NewTaipei_Total"] = sheet.GetRow(i).GetCell(15).ToString().Trim();
                row["CS_Taipei_Total"] = sheet.GetRow(i).GetCell(16).ToString().Trim();
                row["CS_Taoyuan_Total"] = sheet.GetRow(i).GetCell(17).ToString().Trim();
                row["CS_Taichung_Total"] = sheet.GetRow(i).GetCell(18).ToString().Trim();
                row["CS_Tainan_Total"] = sheet.GetRow(i).GetCell(19).ToString().Trim();
                row["CS_Kaohsiung_Total"] = sheet.GetRow(i).GetCell(20).ToString().Trim();
                row["CS_Yilan_Total"] = sheet.GetRow(i).GetCell(21).ToString().Trim();
                row["CS_HsinchuCounty_Total"] = sheet.GetRow(i).GetCell(22).ToString().Trim();
                row["CS_Miaoli_Total"] = sheet.GetRow(i).GetCell(23).ToString().Trim();
                row["CS_Changhua_Total"] = sheet.GetRow(i).GetCell(24).ToString().Trim();
                row["CS_Nantou_Total"] = sheet.GetRow(i).GetCell(25).ToString().Trim();
                row["CS_Yunlin_Total"] = sheet.GetRow(i).GetCell(26).ToString().Trim();
                row["CS_ChiayiCounty_Total"] = sheet.GetRow(i).GetCell(27).ToString().Trim();
                row["CS_Pingtung_Total"] = sheet.GetRow(i).GetCell(28).ToString().Trim();
                row["CS_Taitung_Total"] = sheet.GetRow(i).GetCell(29).ToString().Trim();
                row["CS_Hualien_Total"] = sheet.GetRow(i).GetCell(30).ToString().Trim();
                row["CS_Penghu_Total"] = sheet.GetRow(i).GetCell(31).ToString().Trim();
                row["CS_Keelung_Total"] = sheet.GetRow(i).GetCell(32).ToString().Trim();
                row["CS_HsinchuCity_Total"] = sheet.GetRow(i).GetCell(33).ToString().Trim();
                row["CS_ChiayiCity_Total"] = sheet.GetRow(i).GetCell(34).ToString().Trim();
                row["CS_Kinmen_Total"] = sheet.GetRow(i).GetCell(35).ToString().Trim();
                row["CS_Lienchiang_Total"] = sheet.GetRow(i).GetCell(36).ToString().Trim();
                row["CS_NewTaipei_Sub"] = sheet.GetRow(i).GetCell(37).ToString().Trim();
                row["CS_Taipei_Sub"] = sheet.GetRow(i).GetCell(38).ToString().Trim();
                row["CS_Taoyuan_Sub"] = sheet.GetRow(i).GetCell(39).ToString().Trim();
                row["CS_Taichung_Sub"] = sheet.GetRow(i).GetCell(40).ToString().Trim();
                row["CS_Tainan_Sub"] = sheet.GetRow(i).GetCell(41).ToString().Trim();
                row["CS_Kaohsiung_Sub"] = sheet.GetRow(i).GetCell(42).ToString().Trim();
                row["CS_Yilan_Sub"] = sheet.GetRow(i).GetCell(43).ToString().Trim();
                row["CS_HsinchuCounty_Sub"] = sheet.GetRow(i).GetCell(44).ToString().Trim();
                row["CS_Miaoli_Sub"] = sheet.GetRow(i).GetCell(45).ToString().Trim();
                row["CS_Changhua_Sub"] = sheet.GetRow(i).GetCell(46).ToString().Trim();
                row["CS_Nantou_Sub"] = sheet.GetRow(i).GetCell(47).ToString().Trim();
                row["CS_Yunlin_Sub"] = sheet.GetRow(i).GetCell(48).ToString().Trim();
                row["CS_ChiayiCounty_Sub"] = sheet.GetRow(i).GetCell(49).ToString().Trim();
                row["CS_Pingtung_Sub"] = sheet.GetRow(i).GetCell(50).ToString().Trim();
                row["CS_Taitung_Sub"] = sheet.GetRow(i).GetCell(51).ToString().Trim();
                row["CS_Hualien_Sub"] = sheet.GetRow(i).GetCell(52).ToString().Trim();
                row["CS_Penghu_Sub"] = sheet.GetRow(i).GetCell(53).ToString().Trim();
                row["CS_Keelung_Sub"] = sheet.GetRow(i).GetCell(54).ToString().Trim();
                row["CS_HsinchuCity_Sub"] = sheet.GetRow(i).GetCell(55).ToString().Trim();
                row["CS_ChiayiCity_Sub"] = sheet.GetRow(i).GetCell(56).ToString().Trim();
                row["CS_Kinmen_Sub"] = sheet.GetRow(i).GetCell(57).ToString().Trim();
                row["CS_Lienchiang_Sub"] = sheet.GetRow(i).GetCell(58).ToString().Trim();
        ...
        private void DoCityPlanTable(IWorkbook workbook, SqlConnection oConn, SqlTransaction myTrans)
        {
            ...
            for (int CitySheet = 5; CitySheet < 27; CitySheet++)
            {
                ...
                for (int i = 1; i < sheet.PhysicalNumberOfRows; i++)
                {
                    ...
                    row["CP_AllArea"] = sheet.GetRow(i).GetCell(10).ToString().Trim();
                    row["CP_CityArea"] = sheet.GetRow(i).GetCell(11).ToString().Trim();
                    row["CP_CityAreaDetail"] = sheet.GetRow(i).GetCell(12).ToString().Trim();
                    row["CP_PlanTotalMoney"] = sheet.GetRow(i).GetCell(13).ToString().Trim();
                    row["CP_PlanSubMoney"] = sheet.GetRow(i).GetCell(14).ToString().Trim();
                    row["CP_CityTotalMoney"] = sheet.GetRow(i).GetCell(15).ToString().Trim();
                    row["CP_CitySubMoney"] = sheet.GetRow(i).GetCell(16).ToString().Trim();

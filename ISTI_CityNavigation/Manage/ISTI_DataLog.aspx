<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/BackEnd.Master" AutoEventWireup="true" CodeBehind="ISTI_DataLog.aspx.cs" Inherits="ISTI_CityNavigation.Manage.ISTI_DataLog" %>
    ...
    $(document).ready(function () {
        ...
        function getData(p) {
            $.ajax({
                ...
                url: "mHandler/GetISTI_DataLogList.aspx",
                data: {
                    PageNo: p,

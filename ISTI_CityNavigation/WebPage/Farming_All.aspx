                    ...
                    if ($(data).find("Error").length > 0) {
                        ...
                        if ($(data).find("data_item").length > 0) {
                            ...
                            switch ($("#dll_Category").val()) {
                                case "01":
                                    $("#UnitHead").attr("sortname", "Fa_FarmingLoss");
                                    Unit = "千元";
                                    DataYear = "Fa_FarmingLossYear";
                                    DataVal = "Fa_FarmingLoss";
                                    break;
                                case "02":
                                    $("#UnitHead").attr("sortname", "Fa_AnimalLoss");
                                    Unit = "千元";
                                    DataYear = "Fa_AnimalLossYear";
                                    DataVal = "Fa_AnimalLoss";
                                    break;
                                case "03":
                                    $("#UnitHead").attr("sortname", "Fa_FishLoss");
                                    Unit = "千元";
                                    DataYear = "Fa_FishLossYear";
                                    DataVal = "Fa_FishLoss";
                                    break;
                                case "04":
                                    $("#UnitHead").attr("sortname", "Fa_ForestLoss");
                                    Unit = "千元";
                                    DataYear = "Fa_ForestLossYear";
                                    DataVal = "Fa_ForestLoss";
                                    break;
                                case "04":
                                    $("#UnitHead").attr("sortname", "Fa_ForestLoss");
                                    Unit = "千元";
                                    ...
                                    break;
                                case "05":
                                    $("#UnitHead").attr("sortname", "Fa_AllLoss");
                                    Unit = "千元";
                                    DataYear = "Fa_AllLossYear";
                                    DataVal = "Fa_AllLoss";
                                    break;
                                case "06":
                                    $("#UnitHead").attr("sortname", "Fa_FacilityLoss");
                                    Unit = "千元";
                                    DataYear = "Fa_FacilityLossYear";
                                    DataVal = "Fa_FacilityLoss";
                                    break;
                                case "07":
                                    $("#UnitHead").attr("sortname", "Fa_FarmingOutputValue");
                                    Unit = "千元";
                                    DataYear = "Fa_FarmingOutputValueYear";
                                    DataVal = "Fa_FarmingOutputValue";
                                    break;
                                case "08":
                                    $("#UnitHead").attr("sortname", "Fa_FarmingOutputRate");
                                    Unit = "%";
                                    DataYear = "Fa_FarmingOutputRateYearDesc";
                                    DataVal = "Fa_FarmingOutputRate";
                                    FloatNum = 2;
                                    break;
                                case "09":
                                    $("#UnitHead").attr("sortname", "Fa_Farmer");
                                    Unit = "人";
                                    DataYear = "Fa_FarmerYear";
                                    DataVal = "Fa_Farmer";
                                    break;
                                case "10":
                                    $("#UnitHead").attr("sortname", "Fa_FarmEmploymentOutputValue");
                                    Unit = "千元";
                                    DataYear = "Fa_FarmEmploymentOutputValueYear";
                                    DataVal = "Fa_FarmEmploymentOutputValue";
                                    break;
                            }
                            $(data).find("data_item").each(function (i) {
                                ...
                                // Hightchart Json
                                objData.name = $(this).children("Fa_CityName").text().trim();
                                // 0 & 負數 不進 highchart
                                if (tmpV > 0) {
                                    objData.y = tmpV;
                                    if (JsonStr != '') JsonStr += ',';
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="stripeMeCS hugetable maxHeightD scrollbar-outer font-normal">
                <table border="0" cellspacing="0" cellpadding="0" width="100%" id="tablist">
                    <thead>
                        <tr>
                            <th nowrap="nowrap" style="width: 50px;"><a href="javascript:void(0);" name="sortbtn" sortname="Fa_CityNo">縣市</a></th>
                            <th nowrap="nowrap" style="width: 50px;">資料時間</th>
                            <th nowrap="nowrap" style="width: 150px;"><a id="UnitHead" href="javascript:void(0);" name="sortbtn">臺閩地區農業天然災害產物損失</a></th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
